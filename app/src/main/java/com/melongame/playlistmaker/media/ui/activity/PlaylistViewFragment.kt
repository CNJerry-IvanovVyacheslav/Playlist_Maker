...
import com.melongame.playlistmaker.databinding.FragmentPlaylistViewingBinding
...
class PlaylistViewFragment : Fragment() {
        ...
        bottomSheetBehavior.apply {
            ...
            bottomSheetBehavior.addBottomSheetCallback(object :
                ...
                override fun onSlide(bottomSheet: View, slideOffset: Float) {
                    binding.bottomSheet.isVisible = slideOffset < ZERO
                }
            })
        }
    }
    ...
    private fun showDeleteTrackDialog(track: Track) {
        MaterialAlertDialogBuilder(requireContext(), R.style.AlertDialogCustom)
            ...
            .setNegativeButton(R.string.answer_no) { dialog, _ -> dialog.dismiss() }
    ...
    private fun updatePlaylistStats(tracks: List<Track>) {
        ...
        val totalDurationInMinutes = totalDurationInMillis / MILLS_TO_MINUTES_CHANGE
    ...
    private fun handleSharePlaylist() {
        if (trackAdapter.itemCount == ZERO) {
